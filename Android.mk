...
TEST_CFLAGS := -O3 -ftree-vectorize -ffast-math -funroll-loops -fPIC -fvisibility=hidden

ifeq ($(ARCH_ARM_HAVE_ARMV7A),true) 
	TEST_CFLAGS += -march=armv7-a -mfloat-abi=softfp -mtune=cortex-a9 -mfpu=vfp
endif

ifeq ($(ARCH_ARM_HAVE_NEON),true)
	TEST_CFLAGS += -mfpu=neon -DHAVE_NEON=1 -flax-vector-conversions
endif
